...
* Detecting ouliers in periodic fluctuations over changing baseline, eg e-commerce transactions where the time of day, and even the season, implies varying changes in the data
