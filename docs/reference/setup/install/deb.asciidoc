...
wget http://loudml.s3-website-eu-west-1.amazonaws.com/repo/deb/pool/main/l/loudml/loudml_{version}_all.deb.sha512
shasum -a 512 -c loudml_{version}_all.deb.sha512 <1>
