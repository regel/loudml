...
link:/download[Download Loud ML] page.
...
The following dependencies will have to be installed manually:
[source,sh]
--------------------------------------------------
...
wget http://loudml.s3-website-eu-west-1.amazonaws.com/repo/deb/pool/main/l/loudml-influx/loudml-influx_{version}_all.deb
wget http://loudml.s3-website-eu-west-1.amazonaws.com/repo/deb/pool/main/l/loudml-elastic/loudml-elastic_{version}_all.deb
