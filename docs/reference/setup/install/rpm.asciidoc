...
The RPM for Loud ML can be <<install-rpm,downloaded from the COPR website>>
...
[source,sh]
-------------------------
dnf copr enable regel/loudml  # <1>
-------------------------
...
[source,sh]
-------------------------
yum copr enable regel/loudml  # <1>
-------------------------
<1> Or if you have older distribution
