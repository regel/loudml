...
%install
make -C loudml-warp10 install DESTDIR=%{buildroot}
...
# vendor system)
%exclude %{python3_sitelib}/loudml_warp10*.egg-info/requires.txt
%{python3_sitelib}/loudml/*
%{python3_sitelib}/loudml_warp10*.pth
%dir %{python3_sitelib}/loudml_warp10*.egg-info
%{python3_sitelib}/loudml_warp10*.egg-info/*
