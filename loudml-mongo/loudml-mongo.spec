...
Version: %{version}
Release:	1%{?dist}
Summary:	MongoDB module for Loud ML
...
%install
make -C loudml-mongo install DESTDIR=%{buildroot}
...
# vendor system)
%exclude %{python3_sitelib}/loudml_mongo*.egg-info/requires.txt
%{python3_sitelib}/loudml/*
%{python3_sitelib}/loudml_mongo*.pth
%dir %{python3_sitelib}/loudml_mongo*.egg-info
%{python3_sitelib}/loudml_mongo*.egg-info/*
